...
//    @Autowired
    ...
    public void insertSeeds() {
        ...
        jdbcTemplate.execute("INSERT INTO sales_order_detail (transaction_id, product_id, product_variant_id, price, margin_value, qty,subtotal, margin_price, tax_value, tax_price, total_price, created_at, updated_at)" +
